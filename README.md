...
* ImpactWildcardEncode - Similar to ImpactWildcardProcessor, this provides the loading functionality of LoRAs (e.g. `<lora:some_awesome_lora:0.7:1.2>`). Populated prompts are encoded using the clip after all the lora loading is done. The following examples show how the weights are applied:
  - <lora:some_awesome_lora:0.7:1.2> - weight 0.7 is applied to model/unet and weight 1.2 is applied to clip
  - <lora:some_awesome_lora:0.7> - weight 0.7 is applied to both model/unet and clip
  - <lora:some_awesome_lora::1.2> - weight 1.0 is applied to model/unet and weight 1.2 is applied to clip
  - <lora:some_awesome_lora> - weight 1.0 is applied to both model/unet and clip
